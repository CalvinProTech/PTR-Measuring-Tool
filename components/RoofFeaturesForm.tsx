...
const FEATURE_ITEMS = [
  ...
  },
  {
    ...
    iconPath: "M8.288 15.038a5.25 5.25 0 0 1 7.424-7.424m-1.414 1.414a2.5 2.5 0 1 0-4.596 4.596M12 12l3.75 3.75M3 3l7.5 7.5M12 12l-3.75 3.75M12 3v1.5M3 12h1.5M12 21v-1.5M21 12h-1.5",
  },
];
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm font-medium text-neutral-700">
        Roof Features <span className="font-normal text-neutral-400">(additional costs apply)</span>
      </p>
          ...
          <div
            ...
            className={`rounded-xl p-3 transition-all duration-200 ${
              features[item.hasField]
                ? "border-l-4 border border-primary-200 border-l-primary-500 bg-primary-50/60 shadow-sm"
            ...
            {features[item.hasField] && (
              <div className="mt-2 flex items-center gap-2">
                ...
                <input
                  ...
                  disabled={disabled}
                  className="w-16 rounded-lg border border-neutral-200 px-2 py-1 text-sm focus:border-primary-400 focus:outline-none focus:ring-1 focus:ring-primary-500/20 transition-all duration-200"
                />
              </div>
            )}
          </div>
